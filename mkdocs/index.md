...
No central membership list to keep in sync. The shipped aliases are portable
examples (no machine-specific home paths); replace or extend them for your own
setup.
...
- Example Git, system/Homebrew, MkDocs, and catch-all shortcuts
